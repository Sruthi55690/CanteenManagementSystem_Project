...
public class MenuFactory {
  ...
  public static void insertMenu(int FOOD_ID, String ITEM_NAME, float FOOD_PRICE) {
    dao().insert(FOOD_ID,ITEM_NAME,FOOD_PRICE);
    System.out.println("Record inserted successfully.");
  }

  public static void updateMenu(int FOOD_ID, String ITEM_NAME, float FOOD_PRICE) {
    dao().update(FOOD_ID,ITEM_NAME,FOOD_PRICE);
    System.out.println("Record updated successfully.");
  }

    public static void deleteMenu(int FOOD_ID) {
    dao().delete(FOOD_ID);
