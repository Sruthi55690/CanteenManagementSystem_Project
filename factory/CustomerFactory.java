...
public class CustomerFactory {
  ...
  public static void insertCustomer(String CUS_ID, String CUS_NAME, String CUS_EMAIL, int CUS_PHN, String CUS_ADD) {
    dao().insert(CUS_ID,CUS_NAME,CUS_EMAIL,CUS_PHN,CUS_ADD);
    System.out.println("Record inserted successfully.");
  }

  public static void updateCustomer(String CUS_ID, String CUS_NAME, String CUS_EMAIL, int CUS_PHN, String CUS_ADD) {
